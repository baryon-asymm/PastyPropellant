...
public class TargetFunctionMetricsRecorder : TargetFunctionNonlconSolver
{
    private readonly Stopwatch _stopwatch = new();
    private double _dispersionExecutionTime;

    public TargetFunctionMetricsRecorder(IEnumerable<IEnumerable<double>> experimentalBurningRates,
    ...
    public override void RunTargetFunction(Span<double> x, Span<double> values)
    {
        TargetFunctionCallsCount++;

        _stopwatch.Restart();
        base.RunTargetFunction(x, values);
