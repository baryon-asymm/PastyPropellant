...
#region Properties
    ...
    /// Used for binary search - solving the transcendental equation to find the surface temperature of the propellant (condensed phase).
    /// </summary>
...
#region Abstracts
    ...
    /// </summary>
    /// <param name="pressure">The pressure in the rocket engine combustion chamber, which affects the heat flux calculations.</param>
    ...
    /// <param name="solverParams">Reference to the parameters related to the burn process, including factors such as reaction kinetics and activation energy.</param>
    /// <returns>
...
#region Computation Methods
    ...
    /// <param name="solverParams">A reference to the parameters related to the burn process, including factors like reaction kinetics and activation energy.</param>
    ...
    /// </summary>
    /// <param name="decomposeRate">The rate at which the propellant decomposes, represented as a mass flux (kg/(m²·s)).</param>
    /// <param name="propellantParams">Reference to the parameters related to the propellant, including its density.</param>
    /// <returns>
    ...
    /// <param name="solverParams">Reference to the parameters related to the burn process.</param>
    /// <returns>
...
#region Search The Surface Temperature
    ...
    /// <param name="solverParams">A reference to the parameters related to the burn process, including reaction kinetics and activation energy.</param>
