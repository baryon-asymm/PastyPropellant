# API.md — ParametricCombustionModel.Computation.Tests

Узел проверок. Контракта наружу нет: тестовый проект ни на что не
ссылаются, и его типы никем не используются. Что именно он держит,
