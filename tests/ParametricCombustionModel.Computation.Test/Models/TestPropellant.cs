...
namespace ParametricCombustionModel.Computation.Test.Models;
...
public static class TestPropellant
{
    ...
    public static OptimizationContext GetOptimizationContext()
    {
        ...
        var initialPoint = new double[]
        {
            ...
            141779.70362129132,
            501875.29508437903,
            0.0012389811032742152
        };
        double[] lowerBounds = new double[] { 1e1, 1e1, 1e1, 1e1, 1e1, 1e1, 1.3856, 1e2, 1e2, 1e1 };
        var upperBounds = new double[] { 1e10, 1e7, 1e10, 1e7, 1e10, 1e7, 1.3856, 1e10, 1e7, 1e10 };
